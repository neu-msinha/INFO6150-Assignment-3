...
const openEditPopup = (row) => {
    ...
    const popupContent = `
    <div id="editPopup" class="popup" style="background-color: #f0f0f0; padding: 20px; border-radius: 5px;">
        <h2 style="color: #333;">Edit details of ${studentName}</h2>
        <p style="color: #555;"><strong>Advisor:</strong> ${advisorName}</p>
        <p style="color: #555;"><strong>Award Status:</strong> ${awardStatus}</p>
        <p style="color: #555;"><strong>Semester:</strong> ${semester}</p>
        <p style="color: #555;"><strong>Type:</strong> ${type}</p>
        <p style="color: #555;"><strong>Budget Number:</strong> ${budgetNumber}</p>
        <p style="color: #555;"><strong>Percentage:</strong> ${percentage}</p>
        <button id="updateButton" style="background-color: #4CAF50; color: white; padding: 10px; border: none; border-radius: 3px; cursor: pointer;">Update</button>
        <button id="cancelButton" style="background-color: #f44336; color: white; padding: 10px; border: none; border-radius: 3px; cursor: pointer;">Cancel</button>
    </div>
`;
